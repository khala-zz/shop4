                            ...
                            <?php $__currentLoopData = $categories_share; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($item -> parent == null): ?>
                                    <li class="menu-item-has-children menu-item-has-children-<?php echo e($index + 1); ?>">
                                        ...
                                        <a href="<?php echo e(url('cua-hang?category_id='.$item -> id)); ?>" class="<?php echo e(Request::get('category_id') == $item -> id?'active-khala':''); ?>" >
                                         
                                            <?php echo e($item->title); ?> <i class="ion-ios-arrow-down khala-arrow-right"></i></span>
                                        </a>
                                        <?php else: ?>
                                        <a href="<?php echo e(url('cua-hang?category_id='.$item -> id)); ?>" class="<?php echo e(Request::get('category_id') == $item -> id?'active-khala':''); ?>">
                                 ...
                                 <!-- end hien dau > -->
                                     ...
                                     <ul class="category-mega-menu category-mega-menu-<?php echo e($index + 1); ?>">
                                        <?php echo $__env->make('frontend.shop.menu_category',['childs' => $item -> children], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </ul>
                                    <?php endif; ?>
                                    </li>
                ...
                <li>
                    <div class="sidebar-widget-list-left">
                        <a href="<?php echo e(url()->current().'?brand_filter='.$brand -> id); ?>" class="<?php echo e(Request::get('brand_filter') == $brand -> id?'active-khala':''); ?>">
                            <?php echo e($brand -> title); ?><span>(<?php echo e($brand -> products_count); ?>)</span> 
                        </a>
...
</div><?php /**PATH C:\xampp\htdocs\shop3\resources\views/frontend/shop/filter_shop.blade.php ENDPATH**/ ?>