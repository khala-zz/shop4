<section class="recent-add-area mt-30 mb-30px">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="section-title">
                    ...
                    <p>Có <?php echo e($products_related -> count()); ?> sản phẩm:</p>
                </div>
                <!-- Section Title -->
            </div>
        </div>
        ...
        <div class="recent-product-slider owl-carousel owl-nav-style">
            <!-- Single Item -->
            <?php $__empty_1 = true; $__currentLoopData = $products_related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="add-to-link">
                    <ul>
                        <li class="cart">
                            <a class="cart-btn btn-add-cart" href="<?php echo e(url('add-cart')); ?>" value = "<?php echo e($product -> id.'khala'.$product -> product_code.'khala'.$product -> title.'khala'.$product_price); ?>">THÊM VÀO GIỞ HÀNG </a>
                        </li>
...
</section><?php /**PATH C:\xampp\htdocs\shop3\resources\views/frontend/product/products_relate.blade.php ENDPATH**/ ?>