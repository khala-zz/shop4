        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="section-title">
                    ...
                    <p>Có {{$products_related -> count()}} sản phẩm:</p>
                </div>
                <!-- Section Title -->
            </div>
        </div>
        ...
        <div class="recent-product-slider owl-carousel owl-nav-style">
            ...
            @forelse($products_related as $product)
                ...
                <div class="add-to-link">
                    <ul>
                        <li class="cart">
                            <a class="cart-btn btn-add-cart" href="{{url('add-cart')}}" value = "{{$product -> id.'khala'.$product -> product_code.'khala'.$product -> title.'khala'.$product_price}}">THÊM VÀO GIỞ HÀNG </a>
                        </li>
