                                            ...
                                            <article class="list-product">
                                                <div class="img-block">
                                                    ...
                                                    <div class="quick-view">
                                                        <a class="quick_view khala-quickview" href="#" data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal" value = "{{$valueHome -> id}}" >
                                        ...
                                        @foreach($products_office as $key_office => $value_office)
                                            ...
                                            <article class="list-product">
                                                <div class="img-block">
                                                    ...
                                                    <div class="quick-view">
                                                        <a class="quick_view khala-quickview" href="#" data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal" value = "{{$value_office -> id}}" >
                                                            <i class="ion-ios-search-strong"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                        ...
                                        @foreach($products_light as $key_light => $value_light)
                                            ...
                                            <article class="list-product">
                                                <div class="img-block">
                                                    ...
                                                    <div class="quick-view">
                                                        <a class="quick_view khala-quickview" href="#" data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal" value = "{{$value_light -> id}}" >
                                                            <i class="ion-ios-search-strong"></i>
                                                        </a>
                                                    </div>
                                                </div>
