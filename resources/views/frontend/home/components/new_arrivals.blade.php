                        ...
                        <a href="{{url('san-pham/'.slugify($value_arrivals['title'],'-').'/'.$value_arrivals['id'])}}" class="thumbnail">
                            ...
                            <div class="add-to-link">
                                <ul>
                                    ...
                                    <li>
                                        <a href="#" data-link-action="quickview" title="Quick view" data-toggle="modal" data-target="#exampleModal" value = "{{$value_arrivals['id']}}" class="khala-quickview"><i class="ion-ios-search-strong"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
